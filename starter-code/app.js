...
function multiply(a, b) { //eslint-disable-line
    ...
    var product= 'The product of ' + a + ' and '+ b + ' is ';
...
// Write your code here
function multiplyArray(poop) { //eslint-disable-line
var ab = multiply(poop[0],poop[1])[0];
var abc = multiply(ab,poop[2])[0];
var string = 'The numbers ' + poop + ' have a product of '+ abc + '.';
return[abc,string];
}
...
function multiplyAnyArray(poop) { //eslint-disable-line
  var product = 1;
  for( var i= 0; i <= poop.length-1; i++){
  product = multiply(poop[i],product)[0];
}
var string = 'The numbers ' + poop + ' have a product of ' + product + '.';
